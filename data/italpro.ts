...
export const phases: LearningPhase[] = [
  ...
  {
    id: 'phase-grammar',
    title: 'Grammaire italienne essentielle',
    weeks: 'Parcours permanent',
    goal: 'Comprendre la construction des phrases italiennes avant les exercices: articles, noms, adjectifs, verbes, connecteurs et syntaxe.',
    progress: 0,
    accentColor: '#F97316',
    lessons: [
      "Les phonemes de l'italien",
      "L'article",
      'Le nom',
      "L'adjectif",
      'Les comparatifs',
